...
@Component({
  selector: 'app-notification-type-add-recipient-modal',
  templateUrl: './notification-type-addReicpient-modal.component.html'
})

export class NotificationTypeAddReceipientModalComponent implements OnInit {
  data: any;
